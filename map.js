...
var blues = ["#96AF98","#42E7EA","#63EBBD","#377469","#F1EACA","#45999B","#BBE2BA","#44C3AA","#8CC7BF","#46987C","#6A7B6F","#65EBD6","#C7EDDA","#7BDBDB","#86CCB1"]
var width = 550
var margin_left = 150
var margin_top = 20
...
function drawDots(data,svg){
    ...
    svg.selectAll(".dots")
        ...
        .attr("fill",function(d){
           return yellows[Math.round(Math.random()*15)]
        })
        .attr("opacity",.1)
        .attr("stroke","#fff")
        .attr("stroke-width",2)
